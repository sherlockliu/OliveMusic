 ...
 */
@Controller
@RequestMapping("/sys_role_info")
public class SysRoleInfoController extends BaseCrudController {
    @Resource
    private SysRoleInfoManager sysRoleInfoManager;

    @Override
    public CrudInfo init() {
        return new CrudInfo("sys_role_info/",sysRoleInfoManager);
    }
}