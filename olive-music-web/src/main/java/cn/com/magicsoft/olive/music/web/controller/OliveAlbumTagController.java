 ...
 */
@Controller
@RequestMapping("/olive_album_tag")
public class OliveAlbumTagController extends BaseCrudController {
    @Resource
    private OliveAlbumTagManager oliveAlbumTagManager;

    @Override
    public CrudInfo init() {
        return new CrudInfo("olive_album_tag/",oliveAlbumTagManager);
    }
}