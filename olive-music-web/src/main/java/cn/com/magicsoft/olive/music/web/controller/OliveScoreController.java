 ...
 */
@Controller
@RequestMapping("/olive_score")
public class OliveScoreController extends BaseCrudController {
    @Resource
    private OliveScoreManager oliveScoreManager;

    @Override
    public CrudInfo init() {
        return new CrudInfo("olive_score/",oliveScoreManager);
    }
}