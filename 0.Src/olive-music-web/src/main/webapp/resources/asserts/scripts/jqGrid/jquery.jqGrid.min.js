    ...
    (function(b) {
        ...
        b.extend(b.jgrid, {
            ...
            parseDate: function(d, f, c, e) {
                var a = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, j = "string" === typeof f ? f.match(a) : null, a = function(a, b) {
                    a = "" + a;
                ...
                if (f && null != f)
                    if (!isNaN(f - 0) && "u" === ("" + d).toLowerCase())
                        ...
                        j[3] && (d = 60 * Number(j[5]) + Number(j[6]),
                            d *= "-" === j[4] ? 1 : -1,
                            d -= h.getTimezoneOffset(),
                            h.setTime(Number(Number(h) + 6E4 * d)));
                    else {
                        f = ("" + f).replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe);
                        d = d.replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe);
                        i = 0;
                        for (k = d.length; i < k; i++)
                            "M" === d[i] && (j = b.inArray(f[i], e.monthNames),
                            -1 !== j && 12 > j && (f[i] = j + 1,
                                g.m = f[i])),
                            "F" === d[i] && (j = b.inArray(f[i], e.monthNames, 12),
                            -1 !== j && 11 < j && (f[i] = j + 1 - 12,
                                g.m = f[i])),
                            "a" === d[i] && (j = b.inArray(f[i], e.AmPm),
                            -1 !== j && 2 > j && f[i] === e.AmPm[j] && (f[i] = j,
                                g.h = h(f[i], g.h))),
                            "A" === d[i] && (j = b.inArray(f[i], e.AmPm),
                            -1 !== j && 1 < j && f[i] === e.AmPm[j] && (f[i] = j - 2,
                                g.h = h(f[i], g.h))),
            ...
            from: function(d) {
                return new function(d, c) {
                    ...
                    this._compare = function(a, b, e) {
                        ...
                        !j && "number" !== typeof a && "number" !== typeof b && (a = "" + a,
                            b = "" + b);
                        return a < b ? -e : a > b ? e : 0
                    }
                    ;
                    ...
                    this.startsWith = function(a, d) {
                        ...
                        A ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(0," + c + ") == " + e._getStr('"' + e._toStr(d) + '"')) : (c = g ? b.trim(d.toString()).length : d.toString().length,
                            e._append(e._getStr("this") + ".substr(0," + c + ") == " + e._getStr('"' + e._toStr(a) + '"')));
                        ...
                        dragMove: function(a) {
                            if (this.resizing) {
                                ...
                                33 < c && (this.curGbox.css({
                                    ...
                                    !0 === e.forceFit ? (d = this.headers[this.resizing.idx + e.nv],
                                        b = "ltr" === e.direction ? d.width - b : d.width + b,
                                    33 < b && (a.newWidth = c,
                                        d.newWidth = b)) : (this.newWidth = "ltr" === e.direction ? e.tblwidth + b : e.tblwidth - b,
                                        a.newWidth = c))
                            }
                        },
                        dragEnd: function() {
                            ...
                            if (this.resizing) {
                                ...
                                !0 === e.forceFit ? (d = this.headers[c + e.nv].newWidth || this.headers[c + e.nv].width,
                                    this.headers[c + e.nv].width = d,
                                    this.headers[c + e.nv].el.style.width = d + "px",
                                    this.cols[c + e.nv].style.width = d + "px",
                                0 < this.footers.length && (this.footers[c + e.nv].style.width = d + "px"),
                                    e.colModel[c + e.nv].width = d) : (e.tblwidth = this.newWidth || e.tblwidth,
                                    b("table:first", this.bDiv).css("width", e.tblwidth + "px"),
                                    b("table:first", this.hDiv).css("width", e.tblwidth + "px"),
                                    this.hDiv.scrollLeft = this.bDiv.scrollLeft,
                                e.footerrow && (b("table:first", this.sDiv).css("width", e.tblwidth + "px"),
                                ...
                                if (f) {
                                    ...
                                    if (k < a && 0 >= i && (void 0 === e.lastpage || parseInt((k + g + f - 1) / f, 10) <= e.lastpage))
                                        F = parseInt((a - k + f - 1) / f, 10),
                                            0 <= k || 2 > F || !0 === e.scroll ? (z = Math.round((k + g) / f) + 1,
                                                i = -1) : i = 1;
                                    0 < i && (z = parseInt(g / f, 10) + 1,
                                        F = parseInt((g + a) / f, 10) + 2 - z,
                                        y = !0);
                                    if (F && (!e.lastpage || !(z > e.lastpage || 1 === e.lastpage || z === e.page && z === e.lastpage)))
                                        c.hDiv.loading ? c.timer = setTimeout(c.populateVisible, e.scrollTimeout) : (e.page = z,
                                        y && (c.selectionPreserver(d[0]),
                                            c.emptyRows.call(d[0], !1, !1)),
                                            c.populate(F))
                                }
                            }
                        },
                    ...
                    if ("TABLE" !== this.tagName.toUpperCase())
                        ...
                        if (this.p.colNames.length !== this.p.colModel.length)
                            ...
                            var o = function(a, b) {
                                ...
                                var j = "-1", i = "", k, d = d ? "display:none;" : "", e = "ui-widget-content jqgrow ui-row-" + a.p.direction + (e ? " " + e : "") + (h ? " ui-state-highlight" : ""), h = b(a).triggerHandler("jqGridRowAttr", [g, f, c]);
                                ...
                                if (b.isXMLDoc(c)) {
                                    if (a.p.treeANode === -1 && !a.p.scroll) {
                                        ...
                                        e = e > 1 ? e : 1;
                                    var F = b(a), y, G, l = 0, o, s = a.p.multiselect === true ? 1 : 0, u = 0, n, m = a.p.rownumbers === true ? 1 : 0, t, p = [], E, q = {}, x, D, r = [], K = a.p.altRows === true ? a.p.altclass : "", v;
                                    if (a.p.subGrid === true) {
                                        u = 1;
                            ...
                            "horizontal" === a.p.viewsortcols[1] && (W = " ui-i-asc",
                                oa = " ui-i-desc");
                            ...
                            if (a.p.multiSort) {
                                ...
                                for (g = 0; g < ba.length; g++)
                                    C = b.trim(ba[g]).split(" "),
                                        ba[g] = b.trim(C[0]),
                                        pa[g] = C[1] ? b.trim(C[1]) : a.p.sortorder || "asc"
                            }
                            for (g = 0; g < this.p.colNames.length; g++)
                                C = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[g]) + '"' : "",
                                ...
                                a.p.multiSort && (C = b.inArray(C, ba),
                                -1 !== C && (a.p.colModel[g].lso = pa[C])),
                                    B += W + "</div></th>";
                            W = null;
                            ...
                            !0 === a.p.autowidth && (B = b(l).innerWidth(),
                                a.p.width = 0 < B ? B : "nw");
                            (function() {
                                var d = 0, e = b.jgrid.cell_width ? 0 : o(a.p.cellLayout, 0), g = 0, f, h = o(a.p.scrollOffset, 0), i, k = false, l, m = 0, n;
                                b.each(a.p.colModel, function() {
                            ...
                            a.p.toolbar[0] && (c.uDiv = document.createElement("div"),
                                ...
                                H && b(c.ubDiv).hide()) : b(c.uDiv).width(c.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id),
                            H && b(c.uDiv).hide());
        ...
        b.jgrid.extend({
            ...
            getDataIDs: function() {
                ...
                this.each(function() {
                    if ((c = this.rows.length) && 0 < c)
                        for (; f < c; )
                            b(this.rows[f]).hasClass("jqgrow") && (d[e] = this.rows[f].id,
                                e++),
                                f++
                });
                return d
            ...
            setSelection: function(d, f, c) {
                return this.each(function() {
                    var e, a, j, g, h, i;
                    if (void 0 !== d && (f = !1 === f ? !1 : !0,
                        (a = this.rows.namedItem("" + d)) && a.className && !(-1 < a.className.indexOf("ui-state-disabled"))))
                        if (!0 === this.p.scrollrows && (j = this.rows.namedItem(d).rowIndex,
                            0 <= j && (e = b(this.grid.bDiv)[0].clientHeight,
                                g = b(this.grid.bDiv)[0].scrollTop,
                                h = b(this.rows[j]).position().top,
                                j = this.rows[j].clientHeight,
                                h + j >= e + g ? b(this.grid.bDiv)[0].scrollTop = h - (e + g) + j + g : h < e + g && h < g && (b(this.grid.bDiv)[0].scrollTop = h))),
                            !0 === this.p.frozenColumns && (i = this.p.id + "_frozen"),
                                this.p.multiselect) {
                            if (this.setHeadCheckBox(!1),
                                    this.p.selrow = a.id,
                                    ...
                                    b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(a.id))[this.p.useProp ? "prop" : "attr"]("checked", e),
                                i && (-1 === g ? b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i)).addClass("ui-state-highlight") : b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i)).removeClass("ui-state-highlight"),
                                    b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i))[this.p.useProp ? "prop" : "attr"]("checked", e)),
                                    f)
                            ...
                            i && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(i)).removeClass("ui-state-highlight"),
                ...
                return this.each(function() {
                    ...
                    if (void 0 !== d) {
                        ...
                        if (f.p.multiselect) {
                            ...
                            if (a)
                                b("#jqg_" + b.jgrid.jqID(f.p.id) + "_" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(a))[f.p.useProp ? "prop" : "attr"]("checked", !1);
                            f.setHeadCheckBox(!1)
                        }
                        e = null
                    } else
                        f.p.multiselect ? (b(f.p.selarrrow).each(function(d, e) {
                            ...
                            f.setHeadCheckBox(!1),
                            f.p.selarrrow = []) : f.p.selrow && (b("#" + b.jgrid.jqID(f.p.id) + " tbody:first tr#" + b.jgrid.jqID(f.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected", "false"),
                        a && b("#" + b.jgrid.jqID(f.p.selrow), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"),
                            f.p.selrow = null);
            ...
            delRowData: function(d) {
                ...
                this.each(function() {
                    ...
                    f = !0;
                    this.p.multiselect && (e = b.inArray(d, this.p.selarrrow),
                    -1 !== e && this.p.selarrrow.splice(e, 1));
            ...
            setRowData: function(d, f, c) {
                ...
                this.each(function() {
                    ...
                    if (f)
                        try {
                            if (b(this.p.colModel).each(function(a) {
                                    ...
                                    void 0 !== c && (l[e] = this.formatter && "string" === typeof this.formatter && "date" === this.formatter ? b.unformat.date.call(g, c, this) : c,
                                        h = g.formatter(d, c, a, f, "edit"),
                                        j = this.title ? {
                    ...
                    a && ("string" === k ? b(i).addClass(c) : "object" === k && b(i).css(c),
            ...
            footerData: function(d, f, c) {
                ...
                this.each(function() {
                    ...
                    b(this.p.colModel).each(function(e) {
                        a = this.name;
                        "set" === d ? void 0 !== f[a] && (k = c ? i.formatter("", f[a], e, f, "edit") : f[a],
                            h = this.title ? {
            ...
            showHideCol: function(d, f) {
                return this.each(function() {
                    ...
                    if (c.grid) {
                        ...
                        !0 === e && (!0 === c.p.shrinkToFit && !isNaN(c.p.height) && (c.p.tblwidth += parseInt(c.p.scrollOffset, 10)),
                ...
                return this.each(function() {
                    if (this.grid) {
                        ...
                        if (!isNaN(d)) {
                            ...
                            !0 === c.p.toolbar[0] && (b(c.grid.uDiv).css("width", d + "px"),
                            "both" === c.p.toolbar[1] && b(c.grid.ubDiv).css("width", d + "px"));
                            ...
                            if (!0 === f) {
                                ...
                                c.p.tblwidth > d ? (i = c.p.tblwidth - parseInt(d, 10),
                                    c.p.tblwidth = d,
                                    e = c.p.colModel[g].width -= i) : e = c.p.colModel[g].width;
                    ...
                    if (this.grid && (isNaN(f) ? b(this.p.colModel).each(function(a) {
                        ...
                        if ("" !== c || !0 === j)
                            h = this.formatter(d, c, g, h, "edit"),
                                ...
                                this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(h).attr(i) : b(k).html(h).attr(i),
                            "local" === this.p.datatype && (h = this.p.colModel[g],
                                ...
                                i = this.p._index[b.jgrid.stripPref(this.p.idPrefix, d)],
            ...
            getLocalRow: function(d) {
                var f = !1, c;
                this.each(function() {
                    void 0 !== d && (c = this.p._index[b.jgrid.stripPref(this.p.idPrefix, d)],
                    0 <= c && (f = this.p.data[c]))
                });
                return f
            }
        ...
        a.fn.fmatter.rowactions = function(c) {
            ...
            switch (c) {
                case "edit":
                    ...
                    break;
                case "save":
                    e.jqGrid("saveRow", d, b) && (j.find("div.ui-inline-edit,div.ui-inline-del").show(),
                        j.find("div.ui-inline-save,div.ui-inline-cancel").hide(),
                        e.triggerHandler("jqGridAfterGridComplete"));
                    break;
                case "cancel":
            ...
            sortGrid: function(a, c, f) {
                return this.each(function() {
                    ...
                    if (this.grid) {
                        ...
                        -1 !== g && (j = this.p.colModel[g].sortable,
                        "boolean" !== typeof j && (j = !0),
                        "boolean" !== typeof c && (c = !1),
                        j && this.sortData("jqgh_" + this.p.id + "_" + a, g, c, f))
                    }
                })
            },
            ...
            GridUnload: function() {
                return this.each(function() {
                    if (this.grid) {
                        ...
                        1 === a(this.p.pager).parents("#gbox_" + b).length ? (a(f).insertBefore("#gbox_" + b).show(),
                            a(this.p.pager).insertBefore("#gbox_" + b)) : a(f).insertBefore("#gbox_" + b).show();
                        a(this).jqGrid("clearBeforeUnload");
                        a("#gbox_" + b).remove()
                    }
                })
                ...
                return this.each(function() {
                    ...
                    if (!this.ftoolbar) {
                        var f = function() {
                            ...
                            a("#sopt_menu").remove();
                            var d = parseInt(d, 10), j = parseInt(j, 10) + 18, d = '<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:' + (a(".ui-jqgrid-view").css("font-size") || "11px") + ";left:" + d + "px;top:" + j + 'px;">', j = a(e).attr("soper"), l, h = [], n, i = 0, k = a(e).attr("colname");
                            for (l = c.p.colModel.length; i < l && c.p.colModel[i].name !== k; )
                                i++;
                            i = c.p.colModel[i];
                            k = a.extend({}, i.searchoptions);
                            k.sopt || (k.sopt = [],
                                k.sopt[0] = "select" === i.stype ? "eq" : b.defaultSearch);
                            a.each(b.odata, function() {
                                h.push(this.oper)
                            });
                            for (i = 0; i < k.sopt.length; i++)
                                n = a.inArray(k.sopt[i], h),
                                -1 !== n && (l = j === b.odata[n].oper ? "ui-state-highlight" : "",
                                    d += '<li class="ui-menu-item ' + l + '" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[n].oper + '" oper="' + b.operands[b.odata[n].oper] + '"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="25px">' + b.operands[b.odata[n].oper] + "</td><td>" + b.odata[n].text + "</td></tr></table></a></li>");
                            a("body").append(d + "</ul>");
                        ...
                        a.each(c.p.colModel, function() {
                            var e = this, d, g;
                            g = "";
                            var l = "=", s, n = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + c.p.direction + "'></th>"), i = a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"), k = a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td></tr></table>");
                                ...
                                switch (this.stype) {
                                    case "select":
                                        if (g = this.surl || d.dataUrl)
                                            ...
                                            var m, r, o;
                                            e.searchoptions ? (m = void 0 === e.searchoptions.value ? "" : e.searchoptions.value,
                                                r = void 0 === e.searchoptions.separator ? ":" : e.searchoptions.separator,
                                                o = void 0 === e.searchoptions.delimiter ? ";" : e.searchoptions.delimiter) : e.editoptions && (m = void 0 === e.editoptions.value ? "" : e.editoptions.value,
                                                r = void 0 === e.editoptions.separator ? ":" : e.editoptions.separator,
                                                o = void 0 === e.editoptions.delimiter ? ";" : e.editoptions.delimiter);
                                            if (m) {
                                                ...
                                                if ("string" === typeof m) {
                                                    ...
                                                    for (q in m)
                                                        m.hasOwnProperty(q) && (o = document.createElement("option"),
                                                            o.value = q,
                                                            o.innerHTML = m[q],
                                                            l.appendChild(o));
                ...
                return this.each(function() {
                    ...
                    for (c = 0; c < s; c++)
                        if (e = n[c].el,
                                ...
                                a("<th>", {
                                    role: "gridcell"
                                }).css(h).addClass("ui-first-th-" + this.p.direction).appendTo(m),
                                e.style.width = "",
                                h = o(f.name, b.groupHeaders),
                            0 <= h) {
                            h = b.groupHeaders[h];
                            g = h.numberOfColumns;
                            p = h.titleText;
                            ...
                            0 === g ? b.useColSpanStyle ? d.attr("rowspan", "2") : (a("<th>", {
                                role: "columnheader"
                            }).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
                                display: f.hidden ? "none" : "",
                                "border-top": "0px none"
                            }).insertBefore(d),
                                j.append(e)) : (j.append(e),
                                g--);
        ...
        a.extend(a.jgrid, {
            ...
            createModal: function(d, b, c, g, e, h, f) {
                ...
                j ? (i.dir = "rtl",
                    ...
                    a(".ui-jqdialog-titlebar-close", k).css("left", "0.3em")) : (i.dir = "ltr",
                ...
                g = 0;
                j && b.left && !h && (g = a(c.gbox).width() - (!isNaN(c.width) ? parseInt(c.width, 10) : 0) - 8,
                ...
                if (c.resize)
                    if (a.fn.jqResize)
                        a(i).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se'></div>"),
            ...
            createEl: function(d, b, c, g, e) {
                ...
                switch (d) {
                    ...
                    case "select":
                        ...
                        if (void 0 !== b.dataUrl)
                            d = b.name ? ("" + b.id).substring(0, ("" + b.id).length - ("" + b.name).length - 1) : "" + b.id,
                                g = b.postData || e.postData,
                                i.p && i.p.idPrefix ? d = a.jgrid.stripPref(i.p.idPrefix, d) : g = void 0,
                                a.ajax(a.extend({
                                    url: b.dataUrl,
                                    type: "GET",
                                    dataType: "html",
        ...
        a.jgrid.extend({
                    ...
                    if (e.grid) {
                        ...
                        if (void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0])
                            ...
                            var m = a("<div><div id='" + i + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(e.p.id))
                                , h = "left"
                                , g = "";
                            "rtl" === e.p.direction && (h = "right",
                                g = " style='text-align:left'",
                                m.attr("dir", "rtl"));
                            var n = a.extend([], e.p.colModel), x = "<a href='javascript:void(0)' id='" + i + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + b.Find + "</a>", d = "<a href='javascript:void(0)' id='" + i + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + b.Reset + "</a>", q = "", f = "", o, k = !1, p = -1;
                            ...
                            b.columns.length ? (n = b.columns,
                                p = 0,
                                o = n[0].index || n[0].name) : a.each(n, function(a, b) {
                                if (!b.label)
                            ...
                            k = !1;
                            b.tmplNames && b.tmplNames.length && (k = !0,
                                f = b.tmplLabel,
                                f += "<select class='ui-template'>",
                                f += "<option value='default'>Default</option>",
            ...
            editGridRow: function(r, c) {
                ...
                return this.each(function() {
                            ...
                            if (c.length) {
                                ...
                                a.each(d.p.colModel, function() {
                                    if (this.name === b && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                        try {
                                            if (j[b] = this.editoptions.custom_value.call(d, a("#" + a.jgrid.jqID(b), k), "get"),
                                                void 0 === j[b])
                                                throw "e1";
                                        } catch (c) {
                                ...
                                switch (a(this).get(0).type) {
                                    case "checkbox":
                                        a(this).is(":checked") ? j[this.name] = a(this).val() : (c = a(this).attr("offval"),
                                            j[this.name] = c);
                                        break;
                                    case "select-one":
                    ...
                    function i(c, e, l, g) {
                        ...
                        a(e.p.colModel).each(function(r) {
                            ...
                            if ("cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
                                ...
                                0 === k.length && (k = a("<tr " + m + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + h),
                                    a(k).append(z),
                                    a(l).append(k),
                                    k[0].rp = w);
                        ...
                        if (0 < p && (r = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * g - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + e.p.id + "_id' value='" + c + "'/></td></tr>"),
                                r[0].rp = p + 999,
                                a(l).append(r),
                        ...
                        if ("_empty" === c)
                            a(m).each(function() {
                                ...
                                if ((j = a("#" + a.jgrid.jqID(l), "#" + f)) && j.length && null !== j[0])
                                    if (p = "",
                                            i.defaultValue ? (p = a.isFunction(i.defaultValue) ? i.defaultValue.call(d) : i.defaultValue,
                                                "checkbox" === j[0].type ? (r = p.toLowerCase(),
                                                    0 > r.search(/(false|f|0|no|n|off|undefined)/i) && "" !== r ? (j[0].checked = !0,
                                                        j[0].defaultChecked = !0,
                                                        j[0].value = p) : (j[0].checked = !1,
                                                        j[0].defaultChecked = !1)) : j.val(p)) : "checkbox" === j[0].type ? (j[0].checked = !1,
                                                j[0].defaultChecked = !1,
                                                p = a(j).attr("offval")) : j[0].type && "select" === j[0].type.substr(0, 6) ? j[0].selectedIndex = 0 : j.val(p),
                                    ...
                                    switch (m[j].edittype) {
                                        ...
                                        case "checkbox":
                                            ...
                                            if (m[j].editoptions && m[j].editoptions.value)
                                                ...
                                                g = g.toLowerCase(),
                                                    0 > g.search(/(false|f|0|no|n|off|undefined)/i) && "" !== g ? (a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("checked", !0),
                                                        a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("checked", !1),
                                                        a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                                            break;
                                        case "custom":
                                            try {
                    ...
                    function s() {
                        var e, l = [!0, "", ""], g = {}, h = d.p.prmNames, i, m, r, o, n, z = a(d).triggerHandler("jqGridAddEditBeforeCheckValues", [a("#" + f), v]);
                        ...
                        for (r in j)
                            if (j.hasOwnProperty(r) && (l = a.jgrid.checkValues.call(d, j[r], r),
                                !1 === l[0]))
                                break;
                        u();
                        l[0] && (g = a(d).triggerHandler("jqGridAddEditClickSubmit", [b[d.p.id], j, v]),
                        void 0 === g && a.isFunction(b[d.p.id].onclickSubmit) && (g = b[d.p.id].onclickSubmit.call(d, b[d.p.id], j, v) || {}),
                            l = a(d).triggerHandler("jqGridAddEditBeforeSubmit", [j, a("#" + f), v]),
                        void 0 === l && (l = [!0, "", ""]),
                        ...
                        if (l[0] && !b[d.p.id].processing) {
                            ...
                            if (!0 === d.p.treeGrid)
                                for (n in j[m] === h.addoper && (o = a(d).jqGrid("getGridParam", "selrow"),
                                    j["adjacency" === d.p.treeGridModel ? d.p.treeReader.parent_id_field : "parent_id"] = o),
                                    d.p.treeReader)
                                    d.p.treeReader.hasOwnProperty(n) && (g = d.p.treeReader[n],
                                    j.hasOwnProperty(g) && !(j[m] === h.addoper && "parent_id_field" === n) && delete j[g]);
                            ...
                            !n.url && !b[d.p.id].useDataProxy && (a.isFunction(d.p.dataProxy) ? b[d.p.id].useDataProxy = !0 : (l[0] = !1,
                                l[1] += " " + a.jgrid.errors.nourl));
                            l[0] && (b[d.p.id].useDataProxy ? (g = d.p.dataProxy.call(d, n, "set_" + d.p.id),
                            void 0 === g && (g = [!0, ""]),
                                !1 === g[0] ? (l[0] = !1,
                                    l[1] = g[1] || "Error deleting the selected row!") : (n.data.oper === h.addoper && b[d.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {
                                    gb: "#gbox_" + a.jgrid.jqID(q),
                                    jqm: c.jqModal,
                                    onClose: b[d.p.id].onClose
                                }),
                        ...
                        !1 === l[0] && (a("#FormError>td", k).html(l[1]),
                            a("#FormError", k).show())
                    }
                    function m(a, c) {
                        var b = !1, d;
                    ...
                    if (d.grid && r) {
                        var q = d.p.id, f = "FrmGrid_" + q, o = "TblGrid_" + q, k = "#" + a.jgrid.jqID(o), p = {
                            ...
                            scrollelm: f
                        }, y = a.isFunction(b[d.p.id].beforeShowForm) ? b[d.p.id].beforeShowForm : !1, A = a.isFunction(b[d.p.id].afterShowForm) ? b[d.p.id].afterShowForm : !1, w = a.isFunction(b[d.p.id].beforeInitData) ? b[d.p.id].beforeInitData : !1, B = a.isFunction(b[d.p.id].onInitializeForm) ? b[d.p.id].onInitializeForm : !1, l = !0, z = 1, F = 0, j, K, v, f = a.jgrid.jqID(f);
                        "new" === r ? (r = "_empty",
                            v = "add",
                        ...
                        if (void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                            ...
                            a("#FormError", k).hide();
                            b[d.p.id].topinfo ? (a(".topinfo", k).html(b[d.p.id].topinfo),
                                a(".tinfo", k).show()) : a(".tinfo", k).hide();
                            b[d.p.id].bottominfo ? (a(".bottominfo", k + "_2").html(b[d.p.id].bottominfo),
                                a(".binfo", k + "_2").show()) : a(".binfo", k + "_2").hide();
                            t(r, d, f);
                            "_empty" === r || !b[d.p.id].viewPagerButtons ? a("#pData, #nData", k + "_2").hide() : a("#pData, #nData", k + "_2").show();
                            !0 === b[d.p.id].processing && (b[d.p.id].processing = !1,
                                a("#sData", k + "_2").removeClass("ui-state-active"));
                            !0 === a("#" + f).data("disabled") && (a(".confirm", "#" + a.jgrid.jqID(p.themodal)).hide(),
                                a("#" + f).data("disabled", !1));
                            ...
                            w && (a("#pData, #nData", k + "_2").css("float", "right"),
                                a(".EditButton", k + "_2").css("text-align", "left"));
                            ...
                            if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate)
                                H = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + c.bYes + "</a>",
                                    D = "<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + c.bNo + "</a>",
                                    I = "<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + c.bExit + "</a>",
                                    o = c.zIndex || 999,
                                    o++,
                                    a("<div class='" + c.overlayClass + " jqgrid-overlay confirm' style='z-index:" + o + ";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (o + 1) + "'>" + c.saveData + "<br/><br/>" + H + D + I + "</div>").insertAfter("#" + f),
            ...
            viewGridRow: function(r, c) {
                ...
                return this.each(function() {
                    ...
                    function i(b, d, e, g) {
                        var f, h, i, k = 0, p, m, n = [], r = !1, o, q = "<td class='CaptionTD form-view-label ui-widget-content' width='" + c.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", s = "", t = ["integer", "number", "currency"], w = 0, u = 0, y, x, A;
                        for (o = 1; o <= g; o++)
                        ...
                        a(d.p.colModel).each(function(b) {
                            ...
                            if ("cb" !== f && "subgrid" !== f && "rn" !== f && A) {
                                ...
                                0 === i.length && (i = a("<tr " + m + " rowpos='" + l + "'></tr>").addClass("FormData").attr("id", "trv_" + f),
                                    a(i).append(s),
                                    a(e).append(i),
                                    i[0].rp = l);
                    ...
                    function t(b, c) {
                        ...
                        if (h = a(c).jqGrid("getInd", b, !0))
                            a("td", h).each(function(b) {
                                ...
                                "cb" !== d && "subgrid" !== d && "rn" !== d && (f = d === c.p.ExpandColumn && !0 === c.p.treeGrid ? a(this).text() : a(this).html(),
                                    d = a.jgrid.jqID("v_" + d),
                                    a("#" + d + " span", "#" + n).html(f),
                                e && a("#" + d, "#" + n).parents("tr:first").hide(),
                                    g++)
                            }),
                            0 < g && a("#id_g", "#" + n).val(b)
                    }
                    ...
                    if (m.grid && r) {
                        ...
                        if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
                            ...
                            d && (a("#pData, #nData", "#" + n + "_2").css("float", "right"),
                    ...
                    if (e.grid && r) {
                        ...
                        if (void 0 !== a("#" + a.jgrid.jqID(o.themodal))[0]) {
                            ...
                            !0 === b[e.p.id].processing && (b[e.p.id].processing = !1,
                                a("#dData", "#" + g).removeClass("ui-state-active"));
                ...
                return this.each(function() {
                    if (!this.nav) {
                        ...
                        if (h.grid && "string" === typeof b) {
                            void 0 === a("#" + m.themodal)[0] && (!c.alerttop && !c.alertleft && (void 0 !== window.innerWidth ? (c.alertleft = window.innerWidth,
                                ...
                                a.jgrid.createModal(m, "<div>" + c.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                            ...
                            for (x = 0; x < n; x++) {
                                ...
                                0 === x ? (o = b,
                                    k = h.p.id,
                                o === h.p.toppager && (k += "_top",
                                    n = 1)) : (o = h.p.toppager,
                                    k = h.p.id + "_top");
                                "rtl" === h.p.direction && a(f).attr("dir", "rtl").css("float", "right");
                                c.add && (i = i || {},
                                    g = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                    a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.addicon + "'></span>" + c.addtext + "</div>"),
                                    a("tr", f).append(g),
                                    a(g, f).attr({
                                        title: c.addtitle || "",
                                        id: i.id || "add_" + k
                                ...
                                c.edit && (g = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                    e = e || {},
                                    a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"),
                                    a("tr", f).append(g),
                                    a(g, f).attr({
                                        title: c.edittitle || "",
                                        id: e.id || "edit_" + k
                                ...
                                c.view && (g = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                    s = s || {},
                                    a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"),
                                    a("tr", f).append(g),
                                    a(g, f).attr({
                                        title: c.viewtitle || "",
                                        id: s.id || "view_" + k
                                ...
                                c.del && (g = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                    t = t || {},
                                    a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"),
                                    a("tr", f).append(g),
                                    a(g, f).attr({
                                        title: c.deltitle || "",
                                        id: t.id || "del_" + k
                                ...
                                c.search && (g = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                    u = u || {},
                                    a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.searchicon + "'></span>" + c.searchtext + "</div>"),
                                    a("tr", f).append(g),
                                    a(g, f).attr({
                                        title: c.searchtitle || "",
                                        id: u.id || "search_" + k
                                ...
                                u.showOnLoad && !0 === u.showOnLoad && a(g, f).click(),
                                    g = null);
                                c.refresh && (g = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                    a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.refreshicon + "'></span>" + c.refreshtext + "</div>"),
                                    a("tr", f).append(g),
                                    a(g, f).attr({
                                ...
                                h.p._nvtd && (g > h.p._nvtd[0] && (a(o + "_" + c.position, o).width(g),
                                    h.p._nvtd[0] = g),
                                    h.p._nvtd[1] = g);
                                f = g = g = null;
                                this.nav = !0
                        ...
                        this.createTableForGroup = function(g, j) {
                            ...
                            if (!0 === this.p.ruleButtons) {
                                ...
                                for (c = 0; c < n.groupOps.length; c++)
                                    i = g.groupOp === b.p.groupOps[c].op ? " selected='selected'" : "",
                            ...
                            null !== j && (h = a("<input type='button' value='-' title='Delete group' class='delete-group'/>"),
                                e.append(h),
                                h.bind("click", function() {
                        ...
                        this.createTableRowForRule = function(g, j) {
                            ...
                            l.bind("change", function() {
                                ...
                                if (i) {
                                    ...
                                    for (e = 0; e < h.length; e++)
                                        o = a.inArray(h[e], q),
                                        -1 !== o && (0 === k && (g.op = b.p.ops[o].oper),
                                            j += "<option value='" + b.p.ops[o].oper + "'>" + b.p.ops[o].text + "</option>",
                                            k++);
                                    a(".selectopts", f).empty().append(j);
                                    a(".selectopts", f)[0].selectedIndex = 0;
                                    a.jgrid.msie && 9 > a.jgrid.msiever() && (j = parseInt(a("select.selectopts", f)[0].offsetWidth, 10) + 1,
                                        a(".selectopts", f).width(j),
                            ...
                            for (e = m = 0; e < b.p.columns.length; e++) {
                                ...
                                if (!0 === b.p.columns[e].searchoptions.searchhidden && p || p && !r)
                                    p = "",
                                    g.field === b.p.columns[e].name && (p = " selected='selected'",
                                        m = e),
                            ...
                            for (e = 0; e < h.length; e++)
                                o = a.inArray(h[e], q),
                                -1 !== o && (p = g.op === b.p.ops[o].oper ? " selected='selected'" : "",
                            ...
                            d = a("<td></td>");
                            k.append(d);
                            !0 === this.p.ruleButtons && (m = a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),
                                d.append(m),
        ...
        a.jgrid.extend({
            editRow: function(c, b, e, o, l, g, n, h, f) {
                ...
                if ("object" === a.type(d[0]))
                    j = d[0];
                else if (void 0 !== b && (j.keys = b),
                    a.isFunction(e) && (j.oneditfunc = e),
                    a.isFunction(o) && (j.successfunc = o),
                    void 0 !== l && (j.url = l),
                    void 0 !== g && (j.extraparam = g),
                    a.isFunction(n) && (j.aftersavefunc = n),
                    a.isFunction(h) && (j.errorfunc = h),
                        a.isFunction(f))
                ...
                return this.each(function() {
                    ...
                    if (d.grid && (g = a(d).jqGrid("getInd", c, !0),
                        !1 !== g && "0" === (a(g).attr("editable") || "0") && !a(g).hasClass("not-editable-row")))
                        k = d.p.colModel,
                            a('td[role="gridcell"]', g).each(function(g) {
                                ...
                                if ("cb" !== b && "subgrid" !== b && "rn" !== b && (d.p.autoencode && (f = a.jgrid.htmlDecode(f)),
                                        l[b] = f,
                                    !0 === k[g].editable)) {
                                    null === h && (h = g);
                        ...
                        0 < e && (l.id = c,
                            d.p.savedRow.push(l),
                            a(g).attr("editable", "1"),
                            a("td:eq(" + h + ") input", g).focus(),
                        !0 === j.keys && a(g).bind("keydown", function(f) {
                            if (27 === f.keyCode) {
                            ...
                            a(d).triggerHandler("jqGridInlineEditRow", [c, j]),
                        a.isFunction(j.oneditfunc) && j.oneditfunc.call(d, c))
                })
            },
            saveRow: function(c, b, e, o, l, g, n) {
                ...
                if ("object" === a.type(h[0]))
                    f = h[0];
                else if (a.isFunction(b) && (f.successfunc = b),
                    void 0 !== e && (f.url = e),
                    void 0 !== o && (f.extraparam = o),
                    a.isFunction(l) && (f.aftersavefunc = l),
                    a.isFunction(g) && (f.errorfunc = g),
                        a.isFunction(n))
                ...
                if ("1" === h) {
                                ...
                                case "custom":
                                    try {
                                        if (k.editoptions && a.isFunction(k.editoptions.custom_value)) {
                                            if (i[m] = k.editoptions.custom_value.call(d, a(".customelement", this), "get"),
                                                void 0 === i[m])
                                                throw "e2";
                                        } else
                                            throw "e1";
                    ...
                    if (i) {
                        ...
                        if (void 0 === i[p] || "" === i[p])
                            i[p] = c;
                        else if (q.id !== d.p.idPrefix + i[p] && (h = a.jgrid.stripPref(d.p.idPrefix, c),
                            void 0 !== d.p._index[h] && (d.p._index[i[p]] = d.p._index[h],
                                delete d.p._index[h]),
                                c = d.p.idPrefix + i[p],
                                a(q).attr("id", c),
                            d.p.selrow === u && (d.p.selrow = c),
                            a.isArray(d.p.selarrrow) && (h = a.inArray(u, d.p.selarrrow),
                            0 <= h && (d.p.selarrrow[h] = c)),
                                d.p.multiselect))
                            h = "jqg_" + d.p.id + "_" + c,
                    ...
                    if ("clientArray" === f.url) {
                        ...
                        a("#lui_" + a.jgrid.jqID(d.p.id)).show(),
                            r = a.extend({}, i, r),
                            r[p] = a.jgrid.stripPref(d.p.idPrefix, r[p]),
                            a.ajax(a.extend({
                                url: f.url,
                                ...
                                complete: function(b, g) {
                                    ...
                                    if ("success" === g) {
                                        ...
                                        if (!0 === e) {
                                            ...
                                            a.isFunction(f.errorfunc) && f.errorfunc.call(d, c, b, g, null),
                    ...
                    if (this.grid) {
                        ...
                        b.add && a(e).jqGrid("navButtonAdd", c, {
                            ...
                            onClickButton: function() {
                                ...
                                b.addParams.useFormatter || (a("#" + l + "_ilsave").removeClass("ui-state-disabled"),
                                    a("#" + l + "_ilcancel").removeClass("ui-state-disabled"),
                                    a("#" + l + "_iladd").addClass("ui-state-disabled"),
                                    a("#" + l + "_iledit").addClass("ui-state-disabled"))
                            }
                        });
                        b.edit && a(e).jqGrid("navButtonAdd", c, {
                            ...
                            onClickButton: function() {
                                ...
                                c ? (a(e).jqGrid("editRow", c, b.editParams),
                                    a("#" + l + "_ilsave").removeClass("ui-state-disabled"),
                                    a("#" + l + "_ilcancel").removeClass("ui-state-disabled"),
                                    a("#" + l + "_iladd").addClass("ui-state-disabled"),
                                    a("#" + l + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod", {
                                    gbox: "#gbox_" + l,
                                    jqm: !0
                                }),
                                    a("#jqg_alrt").focus())
                            ...
                            onClickButton: function() {
                                ...
                                if (c) {
                                    var f = e.p.prmNames
                                        , g = f.oper
                                        , d = {};
                                    a("#" + a.jgrid.jqID(c), "#" + l).hasClass("jqgrid-new-row") ? (b.addParams.addRowParams.extraparam[g] = f.addoper,
                                        d = b.addParams.addRowParams) : (b.editParams.extraparam || (b.editParams.extraparam = {}),
                                        b.editParams.extraparam[g] = f.editoper,
                                        d = b.editParams);
                        ...
                        !0 === b.restoreAfterSelect && (o = a.isFunction(e.p.beforeSelectRow) ? e.p.beforeSelectRow : !1,
                                e.p.beforeSelectRow = function(c, f) {
                                    var g = true;
        ...
        d.jgrid.extend({
                        ...
                        if (a.groupField.length) {
                            ...
                            for (b = 0; b < a.groupField.length; b++)
                                ...
                                "boolean" !== typeof a.groupSummary[b] && (a.groupSummary[b] = !1),
                                    !0 === a.groupColumnShow[b] ? (a.visibiltyOnNextGrouping[b] = !0,
                                        d(this).jqGrid("showCol", a.groupField[b])) : (a.visibiltyOnNextGrouping[b] = d("#" + d.jgrid.jqID(this.p.id + "_" + a.groupField[b])).is(":visible"),
                                        d(this).jqGrid("hideCol", a.groupField[b]));
                            a.summary = [];
                            b = 0;
                ...
                this.each(function() {
                    ...
                    for (c = 0; c < k; c++)
                        ...
                        void 0 !== j && (0 === a ? (e.groups.push({
                            ...
                            e.groups[e.counters[c].pos].cnt = e.counters[c].cnt),
                            d.each(e.counters[c].summary, function() {
            ...
            groupingCalculations: {
                handler: function(b, d, f, a, e, h) {
                    ...
                    b = c[b]();
                    null != a && ("fixed" === e ? b = b.toFixed(a) : (a = Math.pow(10, a),
                        b = Math.round(b * a) / a));
                    return b
                }
            }
                ...
                return this.each(function() {
                    ...
                    if (a.grid && a.p.treeGrid)
                        for (var h = a.p.expColInd, e = a.p.treeReader.expanded_field, i = a.p.treeReader.leaf_field, g = a.p.treeReader.level_field, f = a.p.treeReader.icon_field, l = a.p.treeReader.loaded, k, m, n, j; b < c; )
                            ...
                            "nested" === a.p.treeGridModel && !j[i] && (k = parseInt(j[a.p.treeReader.left_field], 10),
                                m = parseInt(j[a.p.treeReader.right_field], 10),
                                j[i] = m === k + 1 ? "true" : "false",
                                a.rows[b].cells[a.p._treeleafpos].innerHTML = j[i]),
                                k = parseInt(j[g], 10),
                                0 === a.p.tree_root_level ? (n = k + 1,
                                    m = k) : (n = k,
                                    m = k - 1),
                                n = "<div class='tree-wrap tree-wrap-" + a.p.direction + "' style='width:" + 18 * n + "px;'>",
                                n += "<div style='" + ("rtl" === a.p.direction ? "right:" : "left:") + 18 * m + "px;' class='ui-icon ",
                            void 0 !== j[l] && (j[l] = "true" === j[l] || !0 === j[l] ? !0 : !1),
                                "true" === j[i] || !0 === j[i] ? (n += (void 0 !== j[f] && "" !== j[f] ? j[f] : a.p.treeIcons.leaf) + " tree-leaf treeclick",
                                    j[i] = !0,
                                    m = "leaf") : (j[i] = !1,
                                    m = ""),
                                j[e] = ("true" === j[e] || !0 === j[e] ? !0 : !1) && (j[l] || void 0 === j[l]),
                                n = !1 === j[e] ? n + (!0 === j[i] ? "'" : a.p.treeIcons.plus + " tree-plus treeclick'") : n + (!0 === j[i] ? "'" : a.p.treeIcons.minus + " tree-minus treeclick'"),
                                n += "></div></div>",
                                d(a.rows[b].cells[h]).wrapInner("<span class='cell-wrapper" + m + "'></span>").prepend(n),
                            k !== parseInt(a.p.tree_root_level, 10) && ((j = (j = d(a).jqGrid("getNodeParent", j)) && j.hasOwnProperty(e) ? j[e] : !0) || d(a.rows[b]).css("display", "none")),
                    ...
                    if (b.p.treeGrid) {
                        ...
                        for (e in b.p.colModel)
                            if (b.p.colModel.hasOwnProperty(e))
                                for (i in h = b.p.colModel[e].name,
                                h === b.p.ExpandColumn && !a && (a = !0,
                                    b.p.expColInd = c),
                                    c++,
                                    b.p.treeReader)
                    ...
                    if (this.grid && this.p.treeGrid) {
                        ...
                        if (!b[c]) {
                            var f = d.jgrid.getAccessor(b, this.p.localReader.id)
                                ...
                                , k = this.p._index[f];
                            d(this).jqGrid("isNodeLoaded", this.p.data[k]) ? (b[c] = !0,
                                d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) : this.grid.hDiv.loading || (b[c] = !0,
                                d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"),
                ...
                if (a) {
                    ...
                    if (void 0 === c || null === c || "" === c)
                        s = c = null,
                            ...
                            r = e.p._index[c],
                            q = e.p.data[r],
                            c = q[e.p.localReader.id],
                            t = parseInt(q[f], 10) + 1,
                            p = d(e).jqGrid("getFullTreeNode", q),
                            p.length ? (s = p = p[p.length - 1][e.p.localReader.id],
                                p = d(e).jqGrid("getInd", s) + 1) : p = d(e).jqGrid("getInd", c) + 1,
                            q[g])
                        u = !0,
                            q[i] = !0,
                    ...
                    if ("nested" === e.p.treeGridModel) {
                        ...
                        if (null !== c) {
                            ...
                            if (f.length)
                                for (o in f)
                                    f.hasOwnProperty(o) && (f[o][k] = f[o][k] > g ? parseInt(f[o][k], 10) + 2 : f[o][k],
                                        f[o][m] = f[o][m] >= g ? parseInt(f[o][m], 10) + 2 : f[o][m]);
                            a[k] = g;
                            a[m] = g + 1
                        } else {
        ...
        json2xml: function(a, b) {
            var g = function(a, b, e) {
                ...
                if (a instanceof Array)
                    ...
                    d += e + "<" + b;
                    for (i in a)
                        a.hasOwnProperty(i) && ("@" === i.charAt(0) ? d += " " + i.substr(1) + '="' + a[i].toString() + '"' : f = !0);
                    d += f ? ">" : "/>";
                    if (f) {
                        for (i in a)
                    ...
                    "function" === typeof a ? d += e + "<" + b + "><![CDATA[" + a + "]]\></" + b + ">" : (void 0 === a && (a = ""),
