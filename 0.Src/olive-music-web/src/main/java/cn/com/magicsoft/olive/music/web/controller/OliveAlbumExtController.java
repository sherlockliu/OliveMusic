 ...
 */
@Controller
@RequestMapping("/olive_album_ext")
public class OliveAlbumExtController extends BaseCrudController {
    @Resource
    private OliveAlbumExtManager oliveAlbumExtManager;

    @Override
    public CrudInfo init() {
        return new CrudInfo("olive_album_ext/",oliveAlbumExtManager);
    }
}