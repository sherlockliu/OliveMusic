 ...
 */
@Controller
@RequestMapping("/olive_artist_tag")
public class OliveArtistTagController extends BaseCrudController {
    @Resource
    private OliveArtistTagManager oliveArtistTagManager;

    @Override
    public CrudInfo init() {
        return new CrudInfo("olive_artist_tag/",oliveArtistTagManager);
    }
}