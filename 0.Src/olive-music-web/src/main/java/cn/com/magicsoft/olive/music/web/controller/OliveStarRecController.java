 ...
 */
@Controller
@RequestMapping("/olive_star_rec")
public class OliveStarRecController extends BaseCrudController {
    @Resource
    private OliveStarRecManager oliveStarRecManager;

    @Override
    public CrudInfo init() {
        return new CrudInfo("olive_star_rec/",oliveStarRecManager);
    }
}