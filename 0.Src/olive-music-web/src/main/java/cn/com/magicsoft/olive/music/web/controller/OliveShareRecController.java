 ...
 */
@Controller
@RequestMapping("/olive_share_rec")
public class OliveShareRecController extends BaseCrudController {
    @Resource
    private OliveShareRecManager oliveShareRecManager;

    @Override
    public CrudInfo init() {
        return new CrudInfo("olive_share_rec/",oliveShareRecManager);
    }
}