 ...
 */
@Controller
@RequestMapping("/olive_album_score")
public class OliveAlbumScoreController extends BaseCrudController {
    @Resource
    private OliveAlbumScoreManager oliveAlbumScoreManager;

    @Override
    public CrudInfo init() {
        return new CrudInfo("olive_album_score/",oliveAlbumScoreManager);
    }
}