...
import cn.com.magicsoft.olive.music.service.SysMenuFunctionService;
 ...
 * 
 */
@Service("sysMenuFunctionManager")
class SysMenuFunctionManagerImpl extends BaseCrudManagerImpl implements SysMenuFunctionManager {
    @Resource
    private SysMenuFunctionService sysMenuFunctionService;

    @Override
    public BaseCrudService init() {
        return sysMenuFunctionService;
    }
}