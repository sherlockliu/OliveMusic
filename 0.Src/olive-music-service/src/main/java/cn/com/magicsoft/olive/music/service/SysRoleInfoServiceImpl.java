...
import cn.com.magicsoft.olive.music.dal.database.SysRoleInfoMapper;
...
class SysRoleInfoServiceImpl extends BaseCrudServiceImpl implements SysRoleInfoService {
    @Resource
    private SysRoleInfoMapper sysRoleInfoMapper;

    @Override
    public BaseCrudMapper init() {
        return sysRoleInfoMapper;
    }
}