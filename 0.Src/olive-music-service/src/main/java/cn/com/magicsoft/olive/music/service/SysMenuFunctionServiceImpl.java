...
import cn.com.magicsoft.olive.music.dal.database.SysMenuFunctionMapper;
...
class SysMenuFunctionServiceImpl extends BaseCrudServiceImpl implements SysMenuFunctionService {
    @Resource
    private SysMenuFunctionMapper sysMenuFunctionMapper;

    @Override
    public BaseCrudMapper init() {
        return sysMenuFunctionMapper;
    }
}